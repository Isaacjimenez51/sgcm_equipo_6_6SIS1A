...
<html>
    ...
    <body>
        <h1>Consulta de Historial Clinico</h1>
        <br>
            ...
            <table border="2" width="920" height="80" borderColor="#AAEE00">
                <thead>
                    <tr>
                        ...
                        <td bfcolor="cyan" width="230" headers="19" >Descripcion</td>
                ...
                <tbody>
                    ...
                    try{
                        ...
                        String q = "select * from registrohistorial order by nom_usu ASC";
                        ...
                        while(rs.next()){
                         ...
                         <tr>
                             ...
                             <td bfcolor="cyan" width="290" headers="19"  > <%=rs.getString(8)%> </td>
